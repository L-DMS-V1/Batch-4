  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      >
        <div className="text-white md:w-1/2">
          ...
          <p className="mt-4 text-lg font-medium text-[#E9EFEC]">
            Boost employee performance and foster growth through our comprehensive training request and management
            system. Submit, track, and manage training requests with ease.
          </p>
        </div>
      </div>
      ...
      <section className="text-center my-8">
        <h2 className="text-3xl font-bold text-[#001F3F]">Our Training Management Features</h2>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-5xl">
          ...
          <div className="bg-[#6A9AB0] rounded-lg shadow-md p-8 transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
            <div className="flex items-center mb-3">
              ...
              <h2 className="text-2xl font-semibold text-[#E9EFEC]">Track Request Status</h2>
            </div>
            <p className="text-[#E9EFEC] text-lg">
              Monitor the status of training requests and keep stakeholders informed throughout the process.
            </p>
          </div>
        </div>
      </section>
...
<section className="flex flex-col md:flex-row items-center my-8 mx-10 bg-[#E9EFEC] p-8 rounded-lg shadow-lg">
  ...
  <div className="w-full md:w-1/2 p-6">
    <h3 className="text-2xl font-bold text-[#001F3F] mb-4">Employee Progress Monitoring</h3>
    <p className="text-lg text-[#3A6D8C]">
      LCD admins can efficiently monitor employee progress on assigned courses, offering insights on completion
      rates and individual development. This feature ensures that employees remain on track with their learning
      goals and allows for timely interventions if needed.
    </p>
  </div>
</section>
...
<section className="mt-10 mx-8 p-8 bg-[#E9EFEC] rounded-lg shadow-lg text-[#001F3F]">
  <div className="flex flex-col items-center">
    ...
    <h3 className="text-2xl font-semibold mb-4 text-center text-[#001F3F]">Building Better Programs with Employee Feedback</h3>
    <p className="text-lg text-center text-[#3A6D8C] leading-relaxed max-w-lg">
      Employees are invited to share feedback at the end of each course, providing valuable insights that enable
      LCD admins to refine future programs. This continuous improvement process ensures training stays relevant
      and impactful.
    </p>
  </div>
</section>
...
<div className="my-10"></div> {/* This creates space between the two sections */}

<section className="py-10 px-8 bg-white">
  <h2 className="text-3xl font-bold text-[#001F3F] text-center mb-6">Contact Us</h2>

  <div className="text-center mb-8">
    <p className="text-lg text-gray-700 mb-2">Have questions or need assistance? Reach out to us!</p>
  ...
  <h3 className="text-2xl font-bold text-[#001F3F] text-center mb-4">Follow Us</h3>
  <div className="flex justify-center space-x-6">
    ...
    {/* LinkedIn Icon */}
    <a href="#" aria-label="LinkedIn" className="text-[#001F3F] hover:text-[#3A6D8C] transition duration-300">
