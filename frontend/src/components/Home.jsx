...
<div className="flex justify-between items-center w-full py-4 px-8 bg-transparent">
    ...
    {/* Login Button */}
    <button className="bg-[#16423C] text-white font-semibold px-6 py-2 rounded-full shadow-md hover:bg-[#6A9C89] transition duration-300 transform hover:scale-105">
        Login
    </button>
</div>
