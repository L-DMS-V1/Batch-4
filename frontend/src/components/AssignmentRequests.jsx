...
export default function AssignmentRequests() {
  ...
  return (
    <div
      ...
      style={{ backgroundColor: "#E9EFEC", minHeight: "100vh" }}
    >
      <button
      ...
      {message && (
        <div
          className={`mb-4 p-4 rounded text-center shadow`}
          style={{
            backgroundColor: message.startsWith("Successfully")
              ? "#E9EFEC"
              : "#FFD1D1",
            color: message.startsWith("Successfully")
              ? "#3A6D8C"
              : "#8B0000",
          }}
        >
      ...
      <div className="overflow-x-auto">
        <table
          className="table-auto w-full border-collapse shadow-lg rounded-lg"
          style={{
            borderColor: "#001F3F",
          }}
        >
            ...
            {assignmentRequests.length === 0 ? (
              ...
              assignmentRequests.map((request) => (
                ...
                >
                  ...
                  <td className="px-4 py-2 text-center">{request.requestId}</td>
                  <td className="px-4 py-2 text-center">
                    {request.course.courseName}
                  </td>
                  <td className="px-4 py-2 text-center">
                  ...
                  <td className="px-4 py-2 text-center">{request.status}</td>
                </tr>
              ))
            )}
          </tbody>
          ...
          style={{
            backgroundColor:
              loading || selectedRequests.length === 0
                ? "#6A9AB0"
                : "#001F3F",
            cursor: loading || selectedRequests.length === 0 ? "not-allowed" : "pointer",
          }}
        >
          {loading ? "Processing..." : "Create Course Assignments"}
        </button>
