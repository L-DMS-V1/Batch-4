  ...
  const handleMarkModuleCompleted = async (moduleIndex) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(
          errorData.message || "Failed to mark module as completed"
        );
      }
      ...
      <div className="container mx-auto max-w-4xl p-6 bg-white rounded-lg shadow-lg">
        ...
        {course ? (
          <div className="p-4 bg-gray-50 rounded-lg shadow-inner mb-6">
            ...
            <p>
              <strong>Key Concepts:</strong> {course.keyConcepts}
            </p>
            <div className="mt-4">
        ...
        {progress ? (
          <div className="p-4 bg-gray-50 rounded-lg shadow-inner">
            ...
            <p className="mt-2">
              ...
              {(
                ((progress.completedModules.split("1").length - 1) * 100.0) /
                progress.completedModules.split("").length
              ).toFixed(0)}
              %
            </p>
            <p className="mt-2">
              <strong>Completed Modules:</strong>{" "}
              {progress.completedModules.split("1").length - 1}
            </p>
          </div>
        ) : (
